          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md text-blue-700 placeholder:text-gray-400"
              />
            </div>

            <div>
              <label className="w-full px-3 py-2 border border-gray-300 rounded-md text-blue-700 placeholder:text-gray-400">
                Workload (1-5)
              </label>
              <input
                type="number"
